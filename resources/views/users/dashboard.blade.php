...
<head>
    ...
    <link href="{{URL::to('src/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css')}}" rel="stylesheet" type="text/css" media="screen"/>
    <!-- owl carousel -->
...
<section id="container" class="">
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li id="mail_notificatoin_bar" class="dropdown">
                    ...
                    <ul class="dropdown-menu extended inbox">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo"><img alt="avatar" src="{{URL::to('src/img/avatar-mini.jpg')}}"></span>
                                    <span class="subject">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu extended logout">
                        ...
                        <li class="eborder-top">
                            {{--$i = {{Auth::user()->id}}--}}
                            <a href="{{route('profile',Auth::user()->id)}}"><i class="icon_profile"></i> My
                                Profile</a>
                        </li>
                        <li>
    ...
    <section class="row new-post">
        <div class="col-md-6 col-md-offset-3">
            <header><h3>Post For Today!</h3></header>
            @if(count($errors)> 0)
                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <form action="{{route('post')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <textarea name="post" class="form-control" cols="30" rows="5"></textarea>
                                </div>
                                <br>
    ...
    <section class="row posts">
        <div class="col-md-6 col-md-offset-3">
            <header><h3>Today's Other's Post</h3></header>
            @foreach($posts as $post)
                <article class="post">
                    ...
                    @endif
                    <div class="info"><i>Posted By {{$post->user->first_name." ".$post->user->last_name}} on
                        {{$post->created_at}}</i></div><div class="info"></div>
